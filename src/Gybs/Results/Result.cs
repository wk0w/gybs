...
public static class Result
{
    ...
    public static IResult<TData?> Copy<TData>(
        IResult result,
        TData? data,
    ...
    {
        return Factory.CreateSuccess(data, null);
    }
    ...
    /// <returns>The result.</returns>
    public static IResult Failure(IReadOnlyDictionary<string, IReadOnlyCollection<string>> errors)
    {
        return Factory.CreateFailure(errors, null);
    }
    ...
    /// <returns>The result.</returns>
    public static IResult Failure(string key, params string[] messages)
    {
        return Failure(new ResultErrorsDictionary().Add(key, messages));
    }
    ...
    /// <param name="messages">The messages.</param>
    /// <returns>The result.</returns>
    public static IResult Failure<TType>(Expression<Func<TType, object>> propertyExpression, params string[] messages)
    {
        return Failure(new ResultErrorsDictionary().Add(propertyExpression, messages));
    }
}
