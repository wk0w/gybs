...
public static class ResultExtensions
{
    ...
    public static IResult<TData> ToSuccessfulResult<TData>(this TData data)
    {
    ...
    {
        return Result.Copy<TOutputData?>(inputResult, default);
    }
    ...
    {
        return Result.Copy(result, result.Data, metadata: metadata);
    }
    ...
    {
        return Result.Copy<object?>(result, null, metadata: metadata);
    }
}
