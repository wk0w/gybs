...
public class ResultErrorsDictionaryTests
{
    ...
    internal class Model
    {
        ...
        public InnerModel PropertyB { get; init; } = new();

        public IList<InnerModel> CollectionA { get; init; } = new List<InnerModel>();

        public class InnerModel
        {
            public IList<InnerModelInnerStruct> CollectionB { get; init; } = new List<InnerModelInnerStruct>();
            public InnerModelInnerStruct PropertyC { get; init; }
